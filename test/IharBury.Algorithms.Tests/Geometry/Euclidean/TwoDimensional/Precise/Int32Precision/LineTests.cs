...
namespace IharBury.Algorithms.Tests.Geometry.Euclidean.TwoDimensional.Precise.Int32Precision
{
    public class LineTests
    {
        ...
        public void WhenDetectingIfAPointIsOnTheLineItSupportsWholeInt32Range()
        {
            ...
            Assert.True(
                new Line(new Point(int.MinValue, int.MinValue), new Point(int.MaxValue, int.MaxValue))
                    .HasPoint(new Point(int.MinValue + 1, int.MinValue + 1)));
            Assert.True(
                new Line(new Point(int.MinValue, int.MaxValue), new Point(int.MinValue, int.MaxValue))
                    .HasPoint(new Point(int.MinValue + 1, int.MaxValue - 1)));
        }
