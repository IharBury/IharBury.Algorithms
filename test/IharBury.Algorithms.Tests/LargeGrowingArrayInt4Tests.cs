...
namespace IharBury.Algorithms.Tests
{
    public class LargeGrowingArrayInt4Tests
    {
        ...
        public void CanAddOneItemToNonEmptyArray()
        {
            ...
            list.Add(2);
            list.Add(13);
            Assert.Equal(new byte[] { 2, 13 }, list);
        }
        ...
        public void CanAddOneItemSoThatPageIsFull()
        {
            ...
            list.Add(13);
            Assert.Equal(Enumerable.Repeat((byte)0, 7).Concat(new byte[] { 13 }), list);
        }
        ...
        public void CanAddOneItemToNewPage()
        {
            ...
            list.Add(12);
            Assert.Equal(Enumerable.Repeat((byte)0, 8).Concat(new byte[] { 12 }), list);
        }
        ...
        public void CanRemoveLastItemFromPageWithOneItem()
        {
            ...
            list.Add(13);
            list.RemoveLast();
            Assert.Equal(Enumerable.Repeat((byte)0, 8), list);
        }
        ...
        public void CanRemoveLastItemFromFullPage()
        {
            ...
            list.AddAll(Enumerable.Repeat((byte)0, 8));
            list.RemoveLast();
            Assert.Equal(Enumerable.Repeat((byte)0, 7), list);
        }
        ...
        public void CanGrowAddRemoveMultipleTimes()
        {
            ...
            Assert.Equal(new byte[] { 1, 2, 13, 1, 1, 2, 1, 2, 3, 1, 2, 3 }, list);
        }
